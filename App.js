...
function App() {
  ...
  <div class="page-section banner-seo-check">
    <div class="wrap bg-image" style={{backgroundImage: 'url(../assets/img/bg_pattern.svg)'}}>
  ...
  <footer class="page-footer bg-image" style={{backgroundImage: 'url(../assets/img/world_pattern.svg)'}}>
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-lg-3 py-3">
          <h5>Contact Us</h5>
          <p>213 Real St. Mountain View, Voyage, Sofia, Bulgaria</p>
          <a href="#" class="footer-link">+359 000 111 222</a>
          <a href="#" class="footer-link">grand@mother.com</a>
        </div>
        <div class="col-lg-3 py-3">
          <h5>Newsletter</h5>
      ...
      <p class="text-center" id="copyright">Copyright &copy; 2024. This template design and develop by <a href="https://macodeid.com/" target="_blank">Maiden LTD</a></p>
    </div>
  </footer>
    </div>
  </div>
